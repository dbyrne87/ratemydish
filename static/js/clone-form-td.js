$(function () {
    ...
    */
        ...
        newElem.find('.label_instructions').attr('id', 'ID' + newNum + '_reference').attr('name', 'ID' + newNum + '_reference').html('Step #' + newNum);

        // Email input - text
        newElem.find('.label_instructions').attr('for', 'ID' + newNum + '_email_address');
        newElem.find('.input_instructions').attr('id', 'ID' + newNum + '_email_address').attr('name', 'ID' + newNum + '_email_address').val('');
